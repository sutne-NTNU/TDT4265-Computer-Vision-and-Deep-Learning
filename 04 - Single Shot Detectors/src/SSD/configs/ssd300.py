...
data_train = dict(
    dataset=L(MNISTDetectionDataset)(
        ...
        transform=L(torchvision.transforms.Compose)(transforms=[
            ...
            L(GroundTruthBoxesToAnchors)(
                anchors="${anchors}", iou_threshold=0.5),
        ])
    ),
    ...
    gpu_transform=L(torchvision.transforms.Compose)(transforms=[
        # Normalize has to be applied after ToTensor (GPU transform is always after CPU)
