...
class BaseTrainer:
    ...
    def train(
        ...
        global_step = 0
        early_stop_counter, lowest_validation_loss = 0, np.inf

        progress = trange(num_epochs, desc="Training", unit="epochs",
        ...
        for epoch in progress:
            ...
            for X_batch, Y_batch in iter(train_loader):
                ...
                if global_step % num_steps_per_val == 0:
                    ...
                    # stop the training if the validation loss does not improve after passing
                    # through 20% of the training dataset 10 times.
                    if val_loss < lowest_validation_loss:
                        ...
                        if early_stop_counter == 50:
                            progress.set_description('Early Stopping')
